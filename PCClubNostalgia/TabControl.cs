...
namespace PCClubNostalgia
{
    ...
    /// </summary>
    public class TabControlV : System.Windows.Forms.TabControl
    {
        /// <summary> 
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            ControlPaint.DrawBorder(e.Graphics, r, EdgeColor, ButtonBorderStyle.Outset);
            //Draw the Tabs
            for (int index = 0; index <= TabCount - 1; index++)
            {
                ...
                e.Graphics.FillRectangle(PaintBrush, r);
                //r.Size = new Size(r.Width, r.Height + 5);
                //r.Inflate(3, 3);
                ControlPaint.DrawBorder(e.Graphics, r, EdgeColor, bs);
